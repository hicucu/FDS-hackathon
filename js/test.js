...
(function game(targetNum) {
  ...
  function stationClick(e) {
    ...
    printLog(STATION_LIST[target.innerText]);
  ...
  function tempAddEnding() {
    if (!document.querySelector('.ending-frame')) ending();
  }
  function tempRemoveEnding() {
    if (document.querySelector('.ending-frame')) {
      document.querySelector('.ending-frame').remove();
    }
  }
  ...
  function setViewer() {
    {
      document.querySelector('#button1').onclick = tempAddEnding;
      document.querySelector('#button2').onclick = tempRemoveEnding;
    }
  }
